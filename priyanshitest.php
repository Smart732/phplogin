                ...
                <div class="form-check mt-2 ">
                  ...
                  ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mobile" placeholder="Mobile number" name="mobilenumber">
                    </div>
                    <div class="mb-3">
                    ...
                    <input type="text" id="Pin_code" name="pin" pattern="[0-9]{6}" maxlength="6">
                          ...
                          <div class="exam" style="width:100%">
                          <div name="10th" value="10th">10th</div>
                          ...
                          <div><input type="text" placeholder="enter" name="tenparcent" id="tenparcent"></div>
                          <div><input type="text" placeholder="enter" name="tenremark" id="tenremark"></div>
                        </div>
                        <div class="exam" style="width:100%">
                        <div name="12th" value="12th">12th</div>
