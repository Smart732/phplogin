...
<head>
  ...
  <title>Indosoft Admin Panel</title>
  <!-- plugins:css -->
...
<body>
 ...
 session_start();
      ...
      echo $Email;
          if($data=mysqli_query($conn, "SELECT * FROM `adminrole` WHERE `email`='$Email'" )){
                if(mysqli_num_rows($data)){
                
                if($dataa=mysqli_query($conn, "SELECT * FROM `adminrole` WHERE `password`='$Password'" ))
                {
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="index.html"><img src="singhaniay.png" alt="logo"/></a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name"><?php  echo $result[1] ?></span>
            </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/forms/Registration.php">
              <i class="mdi mdi-home menu-icon"></i>
              <span class="menu-title">New Registration</span>
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="pages/forms/Registration_staff.php">
              <i class="mdi mdi-home menu-icon"></i>
              <span class="menu-title">New Staff Registration</span>
            </a>
          </li>
          <!-- <li class="nav-item">
     ...
     <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="student.php?email=<?php echo $result[1] ?>" aria-expanded="false" aria-controls="ui-basic">
              <!-- <i class="mdi mdi-circle-outline menu-icon"></i> -->
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <!-- <a class="nav-link" href="pages/charts/chartjs.html"> -->
              ...
              <span class="menu-title">Due fee</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">
         ...
         <!-- some code -->
        <?php
$query8="SELECT `id`, `studentid`, `fullname`, `birth`, `gender`, `Email`, `mobile`, `Coursecode`, `Coursename`, `fathername`, `address`, `district`, `State`, `Pin_code`, `password` FROM `student_record` WHERE `Email`='$result[2]'";
       
       if($data=mysqli_query($conn,$query8)){
    
        $ham=mysqli_fetch_row($data);
        echo "My name ".$ham[2]."<br>";
        echo "My father Name ".$ham[9]."<br>";
        echo "My Course Code ".$ham[7];
